...
(function () {
    ...
    function build() {
        ...
        btn.setAttribute('aria-label', '클릭 가능 표시');
...
(function () {
    var DESIGN_W = 1400, DESIGN_H = 1062, BP = 1024;
    function getW() {
...
// 섹션2: 모바일에서 '더 알아보기'로 펼치고 '접기'로 다시 접기
(function () {
    var wrap = document.querySelector('#section02 .content-wrapper');
    if (!wrap) return;
    var expandBtn = wrap.querySelector('.botton:not(.botton--collapse)');
    var collapseBtn = wrap.querySelector('.botton--collapse');
    if (!wrap.classList.contains('is-collapsed')) wrap.classList.add('is-collapsed');
    ...
    if (collapseBtn) collapseBtn.addEventListener('click', function (e) {
        ...
        var sec = document.getElementById('section02');
